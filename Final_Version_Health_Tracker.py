...
def set_goal():
    ...
    goal_name_label = tk.Label(set_goal_frame, text="Goal Name:", font=("Arial", 12), fg="#333333")  # Set font and text color
    goal_name_label.pack(pady=5)
    goal_name_entry = tk.Entry(set_goal_frame, font=("Arial", 12))
    goal_name_entry.pack(pady=5)

    # Create and pack the priority label
    priority_label = tk.Label(set_goal_frame, text="Priority:", font=("Arial", 12), fg="#333333")  # Set font and text color
    ...
    for priority in priorities:
        priority_radio = tk.Radiobutton(priority_frame, text=priority, variable=priority_var, value=priority, font=("Arial", 12), fg="#333333")  # Set font and text color
        priority_radio.pack(side=tk.LEFT, padx=5)

    # Create and pack the deadline label
    deadline_label = tk.Label(set_goal_frame, text="Deadline:", font=("Arial", 12), fg="#333333")  # Set font and text color
    ...
    day_label = tk.Label(deadline_frame, text="Day:", font=("Arial", 12), fg="#333333")  # Set font and text color
    day_label.pack(side=tk.LEFT, padx=5)
    day_spinbox = tk.Spinbox(deadline_frame, from_=1, to=31, width=5, font=("Arial", 12))
    day_spinbox.pack(side=tk.LEFT)

    month_label = tk.Label(deadline_frame, text="Month:", font=("Arial", 12), fg="#333333")  # Set font and text color
    month_label.pack(side=tk.LEFT, padx=5)
    month_spinbox = tk.Spinbox(deadline_frame, values=("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"), width=5, font=("Arial", 12))
    month_spinbox.pack(side=tk.LEFT)

    year_label = tk.Label(deadline_frame, text="Year:", font=("Arial", 12), fg="#333333")  # Set font and text color
    year_label.pack(side=tk.LEFT, padx=5)
    year_spinbox = tk.Spinbox(deadline_frame, from_=2023, to=2100, width=8, font=("Arial", 12))
    ...
    def process_goal_input():
        ...
        if not day.isdigit() or not month.isalpha() or not year.isdigit():
            messagebox.showerror("Error", "Invalid deadline input. Please enter valid values.")
            return

        if int(day) < 1 or int(day) > 31 or month not in ("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec") or int(year) < 2023 or int(year) > 2100:
            messagebox.showerror("Error", "Invalid deadline input. Please enter valid values.")
            return
    ...
    submit_button = tk.Button(set_goal_frame, text="Submit", command=process_goal_input, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    ...
    back_button = tk.Button(set_goal_frame, text="Back", command=back_to_menu, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
...
def track_metrics():
    global name
    menu_frame.pack_forget()
    track_frame = tk.Frame(window, bg="#f0f0f0")  # Set background color
    ...
    def track_exercise():
        ...
        try:
            ...
            if exercise_calories < 1:
                raise ValueError
        except ValueError:
            messagebox.showerror("Error", "Calories burned must be a positive number.")
            return

        if "Exercise" not in metrics:
            metrics["Exercise"] = {"calories": exercise_calories}
        else:
            metrics["Exercise"]["calories"] = metrics["Exercise"].get("calories", 0) + exercise_calories
    ...
    def track_sleep():
        ...
        try:
            ...
            messagebox.showerror("Error", "Hours slept must be a positive number.")
            return

        if "Sleep" not in metrics:
            metrics["Sleep"] = {"hours": sleep_hours}
        else:
            metrics["Sleep"]["hours"] = metrics["Sleep"].get("hours", 0) + sleep_hours
    ...
    def track_diet():
        ...
        try:
            ...
            messagebox.showerror("Error", "Calories consumed must be a positive number.")
            return

        if "Diet" not in metrics:
            metrics["Diet"] = {"calories": diet_calories}
        else:
            metrics["Diet"]["calories"] = metrics["Diet"].get("calories", 0) + diet_calories
    ...
    header_track = tk.Label(track_frame, text=f"{name}'s Metrics Tracking", font=("Arial", 16), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    header_track.grid(row=0, column=0, columnspan=2, padx=20, pady=10)

    # Create and pack the exercise tracking section
    exercise_label = tk.Label(track_frame, text="Enter Calories Burned:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    exercise_label.grid(row=1, column=0, padx=10, pady=5, sticky="w")

    exercise_entry = tk.Entry(track_frame, width=10, font=("Arial", 12))
    exercise_entry.grid(row=1, column=1, padx=10, pady=5)

    exercise_button = tk.Button(track_frame, text="Track", command=track_exercise, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    exercise_button.grid(row=1, column=2, padx=10, pady=5)

    # Create and pack the sleep tracking section
    sleep_label = tk.Label(track_frame, text="Enter Hours Slept:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    sleep_label.grid(row=2, column=0, padx=10, pady=5, sticky="w")

    sleep_entry = tk.Entry(track_frame, width=10, font=("Arial", 12))
    sleep_entry.grid(row=2, column=1, padx=10, pady=5)

    sleep_button = tk.Button(track_frame, text="Track", command=track_sleep, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    sleep_button.grid(row=2, column=2, padx=10, pady=5)

    # Create and pack the diet tracking section
    diet_label = tk.Label(track_frame, text="Enter Calories Consumed:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    diet_label.grid(row=3, column=0, padx=10, pady=5, sticky="w")

    diet_entry = tk.Entry(track_frame, width=10, font=("Arial", 12))
    diet_entry.grid(row=3, column=1, padx=10, pady=5)

    diet_button = tk.Button(track_frame, text="Track", command=track_diet, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    diet_button.grid(row=3, column=2, padx=10, pady=5)

    # Create and pack the back button
    back_button = tk.Button(track_frame, text="Back", command=back_to_menu, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
...
def display_metrics():
    global name
    menu_frame.pack_forget()
    metric_frame = tk.Frame(window, bg="#f0f0f0")  # Set background color
    ...
    # Create and pack the header
    header_metrics = tk.Label(metric_frame, text=f"{name}'s Metrics", font=("Arial", 16), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    header_metrics.grid(row=0, column=0, columnspan=6, padx=20, pady=10)

    # Check if any goals are set
    if len(goals) == 0:
        no_goals_label = tk.Label(metric_frame, text="No goals set. Please set a goal before viewing metrics.", fg="#333333", bg="#f0f0f0")  # Set font and background color
        no_goals_label.grid(row=1, column=0, columnspan=6, padx=20, pady=10)

        back_button = tk.Button(metric_frame, text="Back", command=back_to_menu, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    ...
    for goal, data in goals.items():
        goal_frame = tk.Frame(metric_frame, bg="#f0f0f0")  # Set background color
        goal_frame.grid(row=row, column=0, columnspan=7, padx=20, pady=10)

        goal_name_label = tk.Label(goal_frame, text=goal + ":", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        goal_name_label.grid(row=0, column=0, padx=10)

        exercise_label = tk.Label(goal_frame, text="Exercise: " + str(metrics.get("Exercise", {}).get("calories", "-")) + " Calories Burned", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        exercise_label.grid(row=0, column=1, padx=10)

        sleep_label = tk.Label(goal_frame, text="Sleep: " + str(metrics.get("Sleep", {}).get("hours", "-")) + " Hours Slept", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        sleep_label.grid(row=0, column=2, padx=10)

        diet_label = tk.Label(goal_frame, text="Diet: " + str(metrics.get("Diet", {}).get("calories", "-")) + " Calories Consumed", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        diet_label.grid(row=0, column=3, padx=10)

        # Create and grid radio buttons for priority
        priority_label = tk.Label(goal_frame, text="Priority:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        ...
        low_radio = tk.Radiobutton(goal_frame, text="Low", variable=priority_var, value="Low", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        low_radio.grid(row=1, column=1, padx=10, sticky="w")

        medium_radio = tk.Radiobutton(goal_frame, text="Medium", variable=priority_var, value="Medium", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        medium_radio.grid(row=1, column=2, padx=10, sticky="w")

        high_radio = tk.Radiobutton(goal_frame, text="High", variable=priority_var, value="High", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        high_radio.grid(row=1, column=3, padx=10, sticky="w")

        # Create and grid entry box for deadline
        deadline_label = tk.Label(goal_frame, text="Deadline:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        deadline_label.grid(row=2, column=0, padx=10, sticky="w")

        deadline_entry = tk.Entry(goal_frame, width=10, font=("Arial", 12))
        ...
        update_button = tk.Button(goal_frame, text="Update", command=lambda g=goal: update_goal(g), font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
...
def edit_user_information():
    ...
    edit_frame = tk.Frame(window, bg="#f0f0f0")  # Set background color
    edit_frame.pack(padx=20, pady=20)

    # Display current user information for editing
    age_label = tk.Label(edit_frame, text="Age:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    age_label.pack(pady=5)
    age_entry = tk.Entry(edit_frame, font=("Arial", 12))
    age_entry.insert(0, str(age))
    age_entry.pack(pady=5)

    height_label = tk.Label(edit_frame, text="Height (cm):", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    height_label.pack(pady=5)
    height_entry = tk.Entry(edit_frame, font=("Arial", 12))
    height_entry.insert(0, str(height))
    height_entry.pack(pady=5)

    weight_label = tk.Label(edit_frame, text="Weight (kg):", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    weight_label.pack(pady=5)
    weight_entry = tk.Entry(edit_frame, font=("Arial", 12))
    weight_entry.insert(0, str(weight))
    weight_entry.pack(pady=5)

    activity_label = tk.Label(edit_frame, text="Activity Level:", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    for level in activity_levels:
        activity_radio = tk.Radiobutton(edit_frame, text=level, variable=activity_var, value=level, font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
        activity_radio.pack(pady=5)

        def submit_updated_information():
            global age, height, weight, activity_level
    ...
    submit_button = tk.Button(edit_frame, text="Submit", command=submit_updated_information, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    submit_button.pack(pady=10)
    ...
    back_button = tk.Button(edit_frame, text="Back", command=back_to_menu, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    back_button.pack(pady=10)
...
def display_user_stats():
    global user_info
    menu_frame.pack_forget()
    display_frame = tk.Frame(window, bg="#f0f0f0")  # Set background color
    ...
    bmi_label = tk.Label(display_frame, text=f"BMI: {bmi:.2f}", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    bmi_category_label = tk.Label(display_frame, text=f"BMI Category: {bmi_category}", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    bmi_message_label = tk.Label(display_frame, text=bmi_message, font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    bmr_label = tk.Label(display_frame, text=f"BMR: {bmr:.2f} calories", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    calorie_intake_label = tk.Label(display_frame, text=f"Recommended Daily Calorie Intake: {calorie_intake:.2f} calories", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    exercise_duration_label = tk.Label(display_frame, text=f"Exercise Recommendation: {exercise_duration}", font=("Arial", 12), fg="#333333", bg="#f0f0f0")  # Set font, text color, and background color
    ...
    # Create and pack the back button
    back_button = tk.Button(display_frame, text="Back", command=back_to_menu, font=("Arial", 12), fg="#ffffff", bg="#3366cc")  # Set font, text color, and background color
    back_button.pack(pady=10)
...
intro_frame = tk.Frame(window, bg=BG_COLOR)
intro_frame.pack(padx=20, pady=20)

# Create and pack the intro label
intro_label = tk.Label(intro_frame, text="Welcome to Health Tracker!", font=("Arial", 16), fg=TEXT_COLOR, bg=BG_COLOR)
intro_label.pack()

# Create and pack the name label and entry
name_label = tk.Label(intro_frame, text="Name:", fg=TEXT_COLOR, bg=BG_COLOR)
name_label.pack(pady=5)
name_entry = tk.Entry(intro_frame, font=("Arial", 12))
name_entry.pack(pady=5)

# Create and pack the age label and entry
age_label = tk.Label(intro_frame, text="Age:", fg=TEXT_COLOR, bg=BG_COLOR)
age_label.pack(pady=5)
age_entry = tk.Entry(intro_frame, font=("Arial", 12))
age_entry.pack(pady=5)

# Create and pack the height label and entry
height_label = tk.Label(intro_frame, text="Height (cm):", fg=TEXT_COLOR, bg=BG_COLOR)
height_label.pack(pady=5)
height_entry = tk.Entry(intro_frame, font=("Arial", 12))
height_entry.pack(pady=5)

# Create and pack the weight label and entry
weight_label = tk.Label(intro_frame, text="Weight (kg):", fg=TEXT_COLOR, bg=BG_COLOR)
weight_label.pack(pady=5)
weight_entry = tk.Entry(intro_frame, font=("Arial", 12))
weight_entry.pack(pady=5)

# Create and pack the gender label and entry
gender_label = tk.Label(intro_frame, text="Gender (M/F):", fg=TEXT_COLOR, bg=BG_COLOR)
gender_label.pack(pady=5)
gender_entry = tk.Entry(intro_frame, font=("Arial", 12))
gender_entry.pack(pady=5)

# Create and pack the submit button
submit_button = tk.Button(intro_frame, text="Submit", command=intro, font=("Arial", 12, "bold"), fg="white", bg=BUTTON_COLOR)
submit_button.pack(pady=10)
...
menu_label = tk.Label(menu_frame, text="What would you like to do?", font=("Arial", 15), fg=TEXT_COLOR, bg=BG_COLOR)
menu_label.pack(pady=20)

# Create and pack the menu options
option1_button = tk.Button(menu_frame, text="1. Set Goal", command=set_goal, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
option1_button.pack(pady=5)

option2_button = tk.Button(menu_frame, text="2. Track Metrics", command=track_metrics, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
option2_button.pack(pady=5)

option3_button = tk.Button(menu_frame, text="3. Display Metrics", command=display_metrics, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
option3_button.pack(pady=5)

option4_button = tk.Button(menu_frame, text="4. Update User Information", command=edit_user_information, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
option4_button.pack(pady=5)

option5_button = tk.Button(menu_frame, text="5. Display User Statistics", command=display_user_stats, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
option5_button.pack(pady=5)

option6_button = tk.Button(menu_frame, text="6. Exit", command=exit_program, font=("Arial", 12), fg="white", bg=BUTTON_COLOR)
