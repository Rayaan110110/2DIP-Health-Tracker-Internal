...
def track_metrics():
    ...
    # Dictionary to keep track of entry boxes for each metric
    calories_entry_dict = {"Exercise": calories_entry, "Diet": calories_entry}
    hours_entry_dict = {"Exercise": hours_entry, "Sleep": hours_entry, "Diet": hours_entry}
